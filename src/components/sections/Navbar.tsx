      ...
      <div className={`border-b transition-all duration-500 ${scrolled ? 'border-[#2A3B4C]/50' : 'border-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 text-sm font-medium text-[#8B9BB4]">
            ...
            <a href="#content-os" title="Hytahub" className={`relative hover:text-[#4ef4d2] transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#4ef4d2] after:transition-all after:duration-300 hover:after:w-full ${activeSection === 'content-os' ? 'after:w-full' : 'after:w-0'} whitespace-nowrap`}>Hytahub</a>
