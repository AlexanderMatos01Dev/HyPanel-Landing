...
const PatreonIcon = ({ size = 18 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ease-out bg-[#0B0F19]/90 ${scrolled ? 'backdrop-blur-xl shadow-lg shadow-black/10 bg-[#0B0F19]/100' : ''}`}>
      <div className={`border-b transition-all duration-500 ${scrolled ? 'border-[#2A3B4C]/50' : 'border-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 text-sm font-medium text-[#8B9BB4]">
            <a href="#why-hypanel" title="About HyPanel" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'why-hypanel' ? 'after:scale-x-100' : 'after:scale-x-0'} whitespace-nowrap`}>About</a>
            <a href="#server-infrastructure" title="Server infrastructure" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'server-infrastructure' ? 'after:scale-x-100' : 'after:scale-x-0'}`}>Infrastructure</a>
            <a href="#the-forge" title="The Forge visual editor" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'the-forge' ? 'after:scale-x-100' : 'after:scale-x-0'}`}>The Forge</a>
            <a href="#ecosystem" title="Ecosystem" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'ecosystem' ? 'after:scale-x-100' : 'after:scale-x-0'}`}>Ecosystem</a>
            <a href="#faq" title="FAQ" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'faq' ? 'after:scale-x-100' : 'after:scale-x-0'}`}>FAQ</a>
            <a href="/blog" title="Blog" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${isBlogPage ? 'after:scale-x-100 text-white' : 'after:scale-x-0'}`}>Blog</a>
            <a href="#supporters" title="Support & Early Supporters" className={`relative hover:text-white transition-colors duration-200 py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-[#EDA333] after:origin-left after:transition-transform after:duration-300 after:w-full hover:after:scale-x-100 ${activeSection === 'supporters' ? 'after:scale-x-100' : 'after:scale-x-0'} whitespace-nowrap`}>Support</a>
          </div>
          <div className="flex items-center gap-2 md:gap-3">
            <div className="hidden md:flex items-center gap-0.5 border-r border-[#2A3B4C] pr-2 md:pr-3">
              ...
              <a href="https://www.reddit.com/r/HyPanel/" target="_blank" rel="noopener noreferrer" className="p-2 text-[#8B9BB4] hover:text-[#FF4500] hover:bg-[#FF4500]/10 rounded-lg transition-all duration-200" title="Reddit">
                <RedditIcon />
              </a>
              <a href="https://patreon.com/HyPanel" target="_blank" rel="noopener noreferrer" className="p-2 text-[#8B9BB4] hover:text-[#FF424D] hover:bg-[#FF424D]/10 rounded-lg transition-all duration-200" title="Patreon">
                <PatreonIcon />
              </a>
              <a href="https://buymeacoffee.com/hypanel_team" target="_blank" rel="noopener noreferrer" className="p-2 text-[#8B9BB4] hover:text-[#FFDD00] hover:bg-[#FFDD00]/10 rounded-lg transition-all duration-200" title="Buy Me a Coffee">
                <BuyMeCoffeeIcon />
              </a>
            </div>
            <button 
              onClick={() => setIsAlphaModalOpen(true)}
              className="px-3 md:px-5 py-2 md:py-2.5 rounded-lg bg-[#EDA333] text-[#0B0F19] text-xs md:text-sm font-bold hover:bg-[#FFC145] transition-all duration-200 hover:scale-105 shadow-[0_0_20px_-5px_rgba(237,163,51,0.4)] hover:shadow-[0_0_30px_-5px_rgba(237,163,51,0.6)] whitespace-nowrap"
            >
      ...
      {/* Alpha Modal */}
      <AlphaModal isOpen={isAlphaModalOpen} onClose={() => setIsAlphaModalOpen(false)} />
    </nav>
  );
};
