...
export const Hytahub: React.FC = () => {
  ...
  return (
    <section id="hytahub" className="min-h-screen py-16 bg-gradient-to-b from-[#0B0F19] to-[#151D2C] border-t border-[#2A3B4C] scroll-mt-16 flex items-center">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center w-full">
        <div className="order-2 lg:order-1 relative h-[480px]">
          <div className="grid grid-cols-2 gap-4 absolute inset-0 z-10 p-2">
        ...
        <div className="order-1 lg:order-2 space-y-4">
          ...
          <div className="pt-2">
            <a href="#" className="inline-flex px-5 py-2.5 bg-[#4DA6FF] text-[#0B0F19] font-bold rounded-lg hover:bg-[#3b8fd9] transition-all items-center gap-2 text-sm">
