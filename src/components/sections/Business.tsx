    ...
    <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
      ...
      <div className="mt-10 bg-gradient-to-r from-[#EDA333]/10 to-[#4DA6FF]/10 border border-[#2A3B4C] rounded-2xl p-6 md:p-8 text-center backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <a href="https://github.com/HyPanel/hypanel-landing" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-[#151D2C] text-white font-bold rounded-xl hover:bg-[#1F2937] transition-all duration-200 border border-[#2A3B4C] flex items-center gap-2">
